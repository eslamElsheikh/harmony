...
iface = gr.Interface(fn=create_treatment_plan,
                     inputs=["number", "text", "number", "text", "text"],
                     outputs="text",
                     title="Treatment Plan Generator",
                     description="Enter your age, gender, weight, mental illness, and any additional notes to generate a comprehensive treatment plan.")
